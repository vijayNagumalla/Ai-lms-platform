-- Setup script for Coding Profiles Management
...
INSERT IGNORE INTO coding_platforms (id, name, display_name, base_url, profile_url_pattern, scraping_config) VALUES
...
SELECT 'Coding Profiles tables created successfully!' as status;
